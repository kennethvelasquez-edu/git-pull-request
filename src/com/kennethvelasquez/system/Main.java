...
public class Main {
     ...
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 3" \ --body "Se implementó la validación para identificar si un
    ...
    /**
     * Problema 4: Define un número entero y determina si es par o impar.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 4 par impar" git
     * push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 4" \ --body "Se agregó la lógica para determinar si un número
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 5 mayor de tres"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 5" \ --body "Se implementó la comparación de tres números para
    ...
    /**
     * Problema 6: Define la edad de una persona y determina si es mayor o menor
     * de edad.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 6 mayoria edad"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 6" \ --body "Se agregó una condición para determinar si una
    ...
    /**
     * Problema 7: Define una temperatura en grados Celsius y conviértela a
     * Fahrenheit.
     *
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 7 conversion
     * temperatura" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 7" \ --body "Se implementó la conversión de grados Celsius a
     * grados Fahrenheit."
     */
    ...
    /**
     * Problema 8: Define la base y altura de un rectángulo y calcula su área.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 8 area
     * rectangulo" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 8" \ --body "Se agregó el cálculo del área de un rectángulo
     * utilizando su base y altura."
     */
    ...
    /**
     * Problema 11: Define un número del 1 al 7 y muestra el día de la semana
     * correspondiente.
     *
     * Ejemplo: 1 = Lunes 2 = Martes
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 11 dia semana"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 11" \ --body "Se agregó una estructura condicional para mostrar
    ...
    /**
     * Problema 12: Define un número del 1 al 12 y muestra el nombre del mes
     * correspondiente.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 12 nombre mes"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 12" \ --body "Se implementó la lógica para obtener el nombre de
    ...
    /**
     * Problema 13: Utiliza un ciclo para mostrar los números del 1 al 10.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 13 numeros 1 al
     * 10" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 13" \ --body "Se agregó un ciclo para mostrar en pantalla los
     * números del 1 al 10."
     */
    ...
    /**
     * Problema 14: Utiliza un ciclo para mostrar los números pares del 2 al 20.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 14 numeros
     * pares" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 14" \ --body "Se implementó un ciclo que muestra los números
     * pares comprendidos entre 2 y 20."
     */
    ...
    /**
     * Problema 15: Utiliza un ciclo para mostrar los números del 10 al 1 en
     * orden descendente.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 15 cuenta
     * regresiva" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 15" \ --body "Se agregó un ciclo descendente para imprimir los
     * números desde 10 hasta 1."
     */
    ...
    /**
     * Problema 16: Define un número y muestra su tabla de multiplicar del 1 al
     * 10.
     *
     * Ejemplo para 5: 5 x 1 = 5 5 x 2 = 10
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 16 tabla
     * multiplicar" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 16" \ --body "Se implementó un ciclo para generar la tabla de
    ...
    /**
     * Problema 17: Calcula la suma de los números del 1 al 10 utilizando un
     * ciclo.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 17 suma ciclo"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 17" \ --body "Se agregó un acumulador para sumar los números
    ...
    /**
     * Problema 18: Define un número entero positivo y calcula su factorial.
     *
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 18 factorial"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 19 longitud
     * palabra" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 19" \ --body "Se agregó la lógica necesaria para obtener y
     * mostrar la cantidad de caracteres de una palabra."
     */
    ...
    /**
     * Problema 20: Define un texto y muéstralo completamente en letras
     * mayúsculas.
     *
     * Utiliza toUpperCase().
     *
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 20 texto
     * mayusculas" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 20" \ --body "Se implementó la conversión de una cadena de texto
     * a letras mayúsculas."
     */
    ...
    /**
     * Problema 21: Define dos palabras y determina si son iguales.
     *
     * Utiliza equals().
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 21 comparar
     * palabras" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 21" \ --body "Se agregó una comparación entre dos cadenas
    ...
    /**
     * Problema 23: Crea un arreglo con 5 números enteros y muestra todos sus
     * elementos.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 23 recorrer
     * arreglo" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 23" \ --body "Se creó un arreglo de números enteros y se agregó
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 25 mayor
     * arreglo" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 25" \ --body "Se agregó un recorrido para encontrar el valor
     * mayor almacenado dentro de un arreglo."
     */
    ...
    public static void estructuraBaseEjercicio27() {
        ...
        if (precio > 100) {
            ...
            System.out.println("Precio Final: " + valorFinal);
        } else {
            valorFinal = precio;
            System.out.println("Precio Original: " + precio);
            System.out.println("Descuento: " + descuento);
    ...
    /**
     * Problema 28: Define un salario mensual.
     *
     * Si el salario es menor a Q3000, agrega un bono de Q500. Si es igual o
     * mayor a Q3000, no recibe bono.
     *
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 28 bono salario"
     * git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 28" \ --body "Se implementó una condición para asignar un bono
    ...
    /**
     * Problema 30: Define un año y determina si es bisiesto.
     *
     * Regla simplificada: Un año divisible entre 4 puede considerarse bisiesto.
     *
     * Al resolver el problema y comprobar que ejecuta correctamente, borra esta
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 30 anio
     * bisiesto" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 30" \ --body "Se agregó una validación para determinar si un año
     * es divisible entre cuatro."
     */
    ...
    /**
     * Problema 31: Define un número entero positivo y cuenta cuántos números
     ...
     * sección del comentario.
     *
     * git add Main.java git commit -m "feat: resolver problema 31 conteo
     * numeros" git push origin rama_destino
     *
     * gh pr create --base tu-rama --head rama_destino \ --title "Resolver
     * problema 31" \ --body "Se implementó un ciclo que muestra todos los
